...
const uint8_t GPIOPIN[4] = {D5,D1};  // Broches Led - Led Pins
float   t = 0 ;
float   h = 0 ;
float   p = 0;
...
String getPage(){
  ...
  page +=           "<tr><td>BMP180</td><td>Temp&eacute;rature</td><td>"; // Première ligne : température - First line : temperature
  page +=             t;
  page +=             "&deg;C</td><td>";
  page +=             "-</td></tr>";
